...
void main() {
    ...
    `;let e=document.getElementById("right-sidebar");e||(e=document.createElement("div"),e.id="right-sidebar",document.body.appendChild(e)),e.appendChild(t);const n=document.getElementById("difficulty-grid");Yp.forEach(c=>{const u=document.createElement("button");u.className=`difficulty-button ${c.id}`,c.id==="medium"&&u.classList.add("active"),u.innerHTML=`
            <div style="font-size: 20px; margin-bottom: 5px;">${c.name}</div>
            <div class="difficulty-info">${c.description}</div>
        `,u.addEventListener("click",()=>{document.querySelectorAll(".difficulty-button").forEach(d=>{d.classList.remove("active")}),u.classList.add("active"),de.changeDifficulty(c),la()}),n.appendChild(u)});const s=document.createElement("div");s.id="controls",s.innerHTML=`
    ...
    `,document.body.appendChild(s);const r=document.createElement("div");r.id="instructions",r.innerHTML=`
        <h4>🎮 Comment jouer</h4>
    ...
    `,document.getElementById("right-sidebar").appendChild(r);const o=document.createElement("div");o.id="solution-modal",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const l=document.createElement("div");l.id="manual-solution-guide",l.style.position="fixed",l.style.left="20px",l.style.top="120px",l.style.width="320px",l.style.maxWidth="calc(100vw - 24px)",l.style.maxHeight="60vh",l.style.overflowY="auto",l.style.zIndex="150",l.style.display="none",l.innerHTML=`
